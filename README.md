...
6th exp (5/2 1353): same as above except halved image size and feature map size, batch size to 8
...
7th exp (5/2 1910): same as above, except first 3k pure L1, 3k~3.2k linear decay to 0
